...
public class Menu {
    ...
    protected String tempMenuItem(int currentPage, int inputNum){
        return switch (currentPage) {
            case 1 -> burgerMenu.get(inputNum).getName();
            case 2 -> beverageMenu.get(inputNum).getName();
            case 3 -> dessertMenu.get(inputNum).getName();
            default -> "";
        };
    }
}
